...
def create_window_2():
   ...
   #AddToListBox
   list1=["Катерина","Людмила","Зоя","Аліна","Олена","Вікторія","Світлана","Марія","Анна","Дарина","Юлія","Лариса","Анастасія","Антоніна","Оксана","Галина","Тетяна","Василина","Валентина","Інна"]
   list2=["Адам","Щек", "Ігор","Віктор","Гліб","Данило","Євген","Дмитро","Вадим","Олександр","Віталій","Богдан","Сергій","Микола","Володимир","Юрій","Олег","Михайло","Семен"]
   for i in list1:

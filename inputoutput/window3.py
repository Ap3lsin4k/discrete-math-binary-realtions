...
from core.entity_two_groups import TwoGroupsAndTwoRelations
...
def pickle_dump(us):
    all_people = TwoGroupsAndTwoRelations(us.one_set, us.another_set, us.S_relations, us.R_relations)
